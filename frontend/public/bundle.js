        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              return _context2.abrupt("return", categoryNames);

            case 3:
              _context2.next = 5;
              return getAPICategoryNames();
  ...
  */
  ...
  function createSelectCorrectAnswer() {
    $('.answer').each(function addOption() {
      $('#correctAnswer').append($('<option>').attr('value', $(this).val()).text($(this).val()));
    });
  }
  ...
  function createExplanationField(answerNumber, parentElement, required) {
    ...
    var responseError = $('<label></label>').addClass('text-danger form-text').prop('id', textAreaErrorId);
